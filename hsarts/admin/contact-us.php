...
<html lang="en">
    <head>
		...
		{
			$q1=mysql_query("select * from pages where page_name='contactus'");
			if(mysql_num_rows($q1)>0)
			{
				mysql_query("update pages set description='".smart($_POST['wysiwg_full'])."' where page_name='contactus'");			
			}
			else
			{
				mysql_query("insert into pages(page_name,description) values('contactus','".smart($_POST['wysiwg_full'])."')");
			}
		}
		$q2=mysql_query("select * from pages where page_name='contactus'");
				...
				<div class="row-fluid">
                                <div class="span6" style="margin-left:80pt;width:500pt;">
									<form class="form-horizontal well" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
										<fieldset>
											<p class="f_legend">Contact Us Description </p>
