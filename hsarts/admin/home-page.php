...
<html lang="en">
    <head>
		...
		{
			$q1=mysql_query("select * from pages where page_name='homepage'");
			if(mysql_num_rows($q1)>0)
			{
				mysql_query("update pages set description='".smart($_POST['wysiwg_full'])."' where page_name='homepage'");			
			}
			else
			{
				mysql_query("insert into pages(page_name,description) values('homepage','".smart($_POST['wysiwg_full'])."')");
			}
		}
		$q2=mysql_query("select * from pages where page_name='homepage'");
				...
				<div class="row-fluid">
                                <div class="span6" style="margin-left:80pt;width:500pt;">
									<form class="form-horizontal well" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
										<fieldset>
											<p class="f_legend">Home Page Description </p>
